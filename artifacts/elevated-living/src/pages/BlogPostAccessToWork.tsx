    ...
    <Layout>
      ...
      <Section className="pt-0">
        <div className="max-w-2xl mx-auto prose prose-lg prose-headings:font-bold prose-headings:text-foreground prose-p:text-foreground/80 prose-p:leading-relaxed prose-li:text-foreground/80 prose-strong:text-foreground">
          ...
          <p>
            Because the alternative is continuing without any support at all. Because even an imperfect award can change the game. Because the scheme, despite its flaws, remains one of the most flexible, individualised forms of support available — especially for freelancers, part-time workers, and those working from home (according to <a href="#" className="text-primary">Anita's ND Consultancy</a>). And because — here's the quietly brilliant bit — once the grant is in place, you can use part of your VA's time to help you manage the ongoing claims administration too, including the paperwork that comes with the grant itself.
          </p>
          <p>
